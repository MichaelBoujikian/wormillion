...
globalThis.WORMILLION_THEMES = {
  ...
  river: {
    ...
    'South America': [
      ...
      'Oyapock', 'Approuague', 'Nickerie', 'Cottica', 'Mana',
      ...
      'Urubamba', 'Vilcanota', 'Mantaro', 'Pachitea', 'Napo',
    ...
    'Africa': [
      ...
      'Pibor', 'Bahr el Ghazal', 'Bahr el Jebel', 'Victoria Nile', 'Albert Nile',
      ...
      'Luangwa', 'Kafue', 'Chobe', 'Kabompo', 'Luapula',
    ...
    'Europe': [
      ...
      'Slana', 'Bodrog', 'Latorica', 'Laborec', 'Ondava',
      ...
      'Acheron', 'Gallikos', 'Loudias', 'Ergene', 'Tunca',
    ...
    'North America': [
      ...
      'Wenatchee', 'Yakima', 'Methow', 'Okanogan', 'Palouse',
      ...
      'Culiacan', 'Ameca', 'Atoyac', 'Suchiate', 'Hondo',
  ...
  mountain: {
    ...
    'the Himalayas': [
      ...
      'Yalung Kang', 'Talung', 'Kirat Chuli', 'Chomo Lonzo', 'Dorje Lakpa',
      'Langtang Ri', 'Chulu West', 'Chulu East', 'Pisang Peak', 'Tharpu Chuli',
      'Hiunchuli', 'Singu Chuli', 'Kangto',
      'Nanda Kot', 'Hardeol', 'Changabang', 'Dunagiri',
      'Mana Peak', 'Mukut Parbat', 'Satopanth', 'Abi Gamin', 'Kalanag',
      'Nyenchen Tanglha'
    ],
    ...
    'Indonesia': [
      ...
      'Talang', 'Singgalang', 'Mount Pangrango', 'Ciremai', 'Welirang',
    ...
    'volcanoes': [
      ...
      'Humphreys Peak', 'Lassen Peak', 'Mount Jefferson', 'South Sister', 'Three Sisters',
      ...
      'Paricutin', 'Colima Volcano', 'Nevado de Colima', 'Ajusco', 'El Chichon',
      'Tacana', 'Ceboruco', 'Tequila Volcano', 'Tajumulco', 'Fuego',
      'Acatenango', 'Agua Volcano', 'Pacaya', 'Atitlan Volcano', 'Toliman Volcano',
      'San Pedro Volcano', 'Santa Maria Volcano', 'Santiaguito', 'Santa Ana Volcano', 'Izalco',
      ...
      'Welirang', 'Anak Krakatoa', 'Sirung', 'Iya', 'Tandikat',
  ...
  island: {
    ...
    'Indonesia': [
      ...
      // 2026-09-14 expansion
      'Nusa Penida', 'Nusa Lembongan', 'Gili Trawangan', 'Gili Islands', 'Madura',
  ...
  desert: {
    'Africa': [
      ...
      // 2026-09-14 expansion
      'Namib Sand Sea', 'Karoo', 'Sossusvlei', 'Skeleton Coast', 'Tanezrouft',
